...
int start() {
   ...
   */
   ...
   if (Use_Daily_Target) {
      ...
      if (G_i_2 >= 0) {
         do {
            if (// OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_2, 0, 1) && PositionGetInteger(POSITION_MAGIC)() == I_i_0) {
               G_l_1 = trade.PositionCloseTime();
               if (G_l_1 >= iTime(_Symbol, 1440, 0) && PositionGetInteger(POSITION_TYPE)() <= OP_SELL) {
                  G_d_33 = PositionGetDouble(POSITION_PROFIT)();
      ...
      if ((G_d_2 >= Daily_Target)) {
         ...
         if (G_i_70 >= 0) {
            do {
               I_b_7 = // OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_3, 0, 0);
               if (PositionGetString(POSITION_SYMBOL)() == _Symbol) {
                  if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71) {
                     if (PositionGetInteger(POSITION_TYPE)() == OP_BUY) {
                        I_b_7 = trade.PositionClose(PositionGetInteger(POSITION_TICKET)(), PositionGetDouble(POSITION_VOLUME)(), SymbolInfoDouble(_Symbol, SYMBOL_BID), (int)I_d_34, 16711680);
                     }
                     if (PositionGetInteger(POSITION_TYPE)() == OP_SELL) {
                        I_b_7 = trade.PositionClose(PositionGetInteger(POSITION_TICKET)(), PositionGetDouble(POSITION_VOLUME)(), SymbolInfoDouble(_Symbol, SYMBOL_ASK), (int)I_d_34, 255);
                     }
                  }
                  Sleep(1000);
               }
   ...
   if (Hidden_TP) {
      ...
      if (OrdersTotal() > 0) {
         do {
            if (!// OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_4, 0, 0) || (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_0)) {
               G_d_3 = (G_d_3 + PositionGetDouble(POSITION_PROFIT)());
            }
            G_i_4 = G_i_4 + 1;
      ...
      if ((Hiden_TP <= G_d_3)) {
         ...
         if (G_i_73 >= 0) {
            do {
               I_b_7 = // OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_5, 0, 0);
               if (PositionGetString(POSITION_SYMBOL)() == _Symbol) {
                  if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71) {
                     if (PositionGetInteger(POSITION_TYPE)() == OP_BUY) {
                        I_b_7 = trade.PositionClose(PositionGetInteger(POSITION_TICKET)(), PositionGetDouble(POSITION_VOLUME)(), SymbolInfoDouble(_Symbol, SYMBOL_BID), (int)I_d_34, 16711680);
   ...
   if (G_i_8 > 0) {
      do {
         bool order_select = // OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_10, 0, 0);
         if (PositionGetInteger(POSITION_MAGIC)() == I_i_0 && PositionGetString(POSITION_SYMBOL)() == S_s_21 && G_i_7 == PositionGetInteger(POSITION_TYPE)()) {
            G_i_75 = G_i_9 + 1;
            G_i_9 = G_i_75;
         }
         G_i_10 = G_i_10 + 1;
   ...
   if (G_i_12 > 0) {
      do {
         bool order_select = // OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_14, 0, 0);
         if (PositionGetInteger(POSITION_MAGIC)() == I_i_0 && PositionGetString(POSITION_SYMBOL)() == S_s_22 && G_i_11 == PositionGetInteger(POSITION_TYPE)()) {
            G_i_75 = G_i_13 + 1;
            G_i_13 = G_i_75;
         }
         G_i_14 = G_i_14 + 1;
   ...
   if (I_b_13) {
      ...
      if (G_l_3 >= G_l_4) {
         ...
         if (G_i_81 >= 0) {
            do {
               I_b_7 = // OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_15, 0, 0);
               if (PositionGetString(POSITION_SYMBOL)() == _Symbol) {
                  if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71) {
                     if (PositionGetInteger(POSITION_TYPE)() == OP_BUY) {
                        I_b_7 = trade.PositionClose(PositionGetInteger(POSITION_TICKET)(), PositionGetDouble(POSITION_VOLUME)(), SymbolInfoDouble(_Symbol, SYMBOL_BID), (int)I_d_34, 16711680);
   ...
   if (I_i_84 >= 0) {
      do {
         I_b_7 = // OrderSelect equivalent handled via PositionGetTicket in MQL5(I_i_84, 0, 0);
         if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71) {
            if (PositionGetInteger(POSITION_TYPE)() == OP_BUY || PositionGetInteger(POSITION_TYPE)() == OP_SELL) {
               G_d_4 = (G_d_4 + PositionGetDouble(POSITION_PROFIT)());
            }
         }
         I_i_84 = I_i_84 - 1;
      } while (I_i_84 >= 0);
   ...
   if (UseEquityStop && (G_d_4 < 0)) {
      ...
      if (G_i_85 >= 0) {
         do {
            I_b_7 = // OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_17, 0, 0);
            if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71) {
               if (PositionGetInteger(POSITION_TYPE)() == OP_SELL || PositionGetInteger(POSITION_TYPE)() == OP_BUY) {
                  G_i_16 = G_i_16 + 1;
               }
            }
            G_i_17 = G_i_17 - 1;
      ...
      if ((G_d_55 > (G_d_56 * I_d_57))) {
         ...
         if (G_i_85 >= 0) {
            do {
               I_b_7 = // OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_18, 0, 0);
               if (PositionGetString(POSITION_SYMBOL)() == _Symbol) {
                  if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71) {
                     if (PositionGetInteger(POSITION_TYPE)() == OP_BUY) {
                        I_b_7 = trade.PositionClose(PositionGetInteger(POSITION_TICKET)(), PositionGetDouble(POSITION_VOLUME)(), SymbolInfoDouble(_Symbol, SYMBOL_BID), (int)I_d_34, 16711680);
   ...
   if (G_i_87 >= 0) {
      do {
         I_b_7 = // OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_20, 0, 0);
         if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71) {
            if (PositionGetInteger(POSITION_TYPE)() == OP_SELL || PositionGetInteger(POSITION_TYPE)() == OP_BUY) {
               G_i_19 = G_i_19 + 1;
            }
   ...
   if (I_i_84 >= 0) {
      do {
         I_b_7 = // OrderSelect equivalent handled via PositionGetTicket in MQL5(I_i_84, 0, 0);
         if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71) {
            if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetInteger(POSITION_TYPE)() == OP_BUY) {
               I_b_18 = true;
               I_b_19 = false;
               L_d_0 = PositionGetDouble(POSITION_VOLUME)();
               break;
            }
            if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetInteger(POSITION_TYPE)() == OP_SELL) {
               I_b_18 = false;
               I_b_19 = true;
               L_d_1 = PositionGetDouble(POSITION_VOLUME)();
               break;
            }
         }
         I_i_84 = I_i_84 - 1;
   ...
   if (I_i_88 > 0 && I_i_88 <= MaxTrades) {
      ...
      if (G_i_87 >= 0) {
         do {
            I_b_7 = // OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_23, 0, 0);
            if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetInteger(POSITION_TYPE)() == OP_BUY) {
               G_i_21 = PositionGetInteger(POSITION_TICKET)();
               if (G_i_21 > G_i_22) {
      ...
      if (G_i_87 >= 0) {
         do {
            I_b_7 = // OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_26, 0, 0);
            if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetInteger(POSITION_TYPE)() == OP_SELL) {
               G_i_24 = PositionGetInteger(POSITION_TICKET)();
               if (G_i_24 > G_i_25) {
      ...
      if (I_b_20 == 0) {
         if (I_b_18) {
            G_d_65 = (I_d_63 - SymbolInfoDouble(_Symbol, SYMBOL_ASK));
            if ((G_d_65 >= (I_d_47 * _Point))) {
               I_b_22 = true;
            }
         }
         if (I_b_19 != false) {
            G_d_65 = (SymbolInfoDouble(_Symbol, SYMBOL_BID) - I_d_64);
            if ((G_d_65 >= (I_d_47 * _Point))) {
               I_b_22 = true;
            }
         }
         ...
         if (I_b_20 == true && Volume[0] < 5) {
            if (I_b_18) {
               G_d_104 = (I_d_63 - SymbolInfoDouble(_Symbol, SYMBOL_ASK));
               if ((G_d_104 >= (I_d_47 * _Point))) {
                  I_b_22 = true;
               }
            }
            if (I_b_19) {
               G_d_104 = (SymbolInfoDouble(_Symbol, SYMBOL_BID) - I_d_64);
               if ((G_d_104 >= (I_d_47 * _Point))) {
                  I_b_22 = true;
               }
            }
   ...
   if (I_b_22) {
      ...
      if (G_i_89 >= 0) {
         do {
            I_b_7 = // OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_29, 0, 0);
            if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetInteger(POSITION_TYPE)() == OP_BUY) {
               G_i_27 = PositionGetInteger(POSITION_TICKET)();
               if (G_i_27 > G_i_28) {
      ...
      if (G_i_89 >= 0) {
         do {
            I_b_7 = // OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_32, 0, 0);
            if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetInteger(POSITION_TYPE)() == OP_SELL) {
               G_i_30 = PositionGetInteger(POSITION_TICKET)();
               if (G_i_30 > G_i_31) {
      ...
      if (I_b_19 != false) {
         if (I_b_23 || L_s_2 == "true") {
            ...
            if (I_i_76 == -2) {
               ...
               if (I_i_1 == 2) {
                  ...
                  if (G_i_119 >= 0) {
                     do {
                        if (!// OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_34, 0, 1)) {
                           G_d_9 = -3;
                           break;
                        }
                        if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71) {
                           G_l_14 = trade.PositionCloseTime();
                           G_l_15 = G_i_33;
                           if (G_l_15 < G_l_14) {
                              G_i_33 = (int)trade.PositionCloseTime();
                              if ((PositionGetDouble(POSITION_PROFIT)() < 0)) {
                                 if (I_i_77 == 1) {
                                    G_d_10 = NormalizeDouble((PositionGetDouble(POSITION_VOLUME)() * I_d_45), (int)I_d_67);
                                 } else {
                                    G_d_10 = NormalizeDouble((PositionGetDouble(POSITION_VOLUME)() + Lot), (int)I_d_67);
                                 }
                              } else {
                                 G_d_10 = I_d_44;
                              }
         ...
         if (I_b_24 && L_s_1 == "true") {
            ...
            if ((I_d_69 > 0)) {
               ...
               I_i_92 = f0_15(1, I_d_69, SymbolInfoDouble(_Symbol, SYMBOL_BID), (int)I_d_34, SymbolInfoDouble(_Symbol, SYMBOL_ASK), 0, 0, S_s_23, I_i_71, 0, 11823615);
               if (I_i_92 < 0) {
               ...
               if (G_i_91 >= 0) {
                  do {
                     I_b_7 = // OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_37, 0, 0);
                     if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetInteger(POSITION_TYPE)() == OP_SELL) {
                        G_i_35 = PositionGetInteger(POSITION_TICKET)();
                        if (G_i_35 > G_i_36) {
         ...
         if (I_b_18) {
            if (I_b_23 || L_s_2 == "true") {
               ...
               if (I_i_76 == -2) {
                  ...
                  if (I_i_1 == 2) {
                     ...
                     if (G_i_124 >= 0) {
                        do {
                           if (!// OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_39, 0, 1)) {
                              G_d_12 = -3;
                              break;
                           }
                           if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71) {
                              G_l_16 = trade.PositionCloseTime();
                              G_l_17 = G_i_38;
                              if (G_l_17 < G_l_16) {
                                 G_i_38 = (int)trade.PositionCloseTime();
                                 if ((PositionGetDouble(POSITION_PROFIT)() < 0)) {
                                    if (I_i_77 == 1) {
                                       G_d_13 = NormalizeDouble((PositionGetDouble(POSITION_VOLUME)() * I_d_45), (int)I_d_67);
                                    } else {
                                       G_d_13 = NormalizeDouble((PositionGetDouble(POSITION_VOLUME)() + Lot), (int)I_d_67);
                                    }
                                 } else {
                                    G_d_13 = I_d_44;
                                 }
            ...
            if (I_b_24 && L_s_1 == "true") {
               ...
               if ((I_d_69 > 0)) {
                  ...
                  I_i_92 = f0_15(0, I_d_69, SymbolInfoDouble(_Symbol, SYMBOL_ASK), (int)I_d_34, SymbolInfoDouble(_Symbol, SYMBOL_BID), 0, 0, S_s_14, I_i_71, 0, 65280);
                  if (I_i_92 < 0) {
                     Print("Error: ", GetLastError());
                     L_i_15 = 0;
                     return L_i_15;
                  ...
                  if (G_i_93 >= 0) {
                     do {
                        I_b_7 = // OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_42, 0, 0);
                        if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetInteger(POSITION_TYPE)() == OP_BUY) {
                           G_i_40 = PositionGetInteger(POSITION_TICKET)();
                           if (G_i_40 > G_i_41) {
      ...
      if ((Close[0] > L_d_8 && Close[0] < L_d_10) || (Close[0] < L_d_9 && Close[0] > L_d_11)) {
         if (I_b_22 && I_i_88 < 1) {
            ...
            if (G_i_97 == 1) {
               ...
               I_d_74 = SymbolInfoDouble(_Symbol, SYMBOL_BID);
               I_d_75 = SymbolInfoDouble(_Symbol, SYMBOL_ASK);
                  ...
                  if ((L_d_2 > returned_double)) {
                     if (I_i_76 == -2) {
                        ...
                        if (I_i_1 == 2) {
                           ...
                           if (G_i_102 >= 0) {
                              do {
                                 if (!// OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_48, 0, 1)) {
                                    G_d_17 = -3;
                                    break;
                                 }
                                 if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71) {
                                    G_l_6 = trade.PositionCloseTime();
                                    G_l_7 = G_i_47;
                                    if (G_l_7 < G_l_6) {
                                       G_i_47 = (int)trade.PositionCloseTime();
                                       if ((PositionGetDouble(POSITION_PROFIT)() < 0)) {
                                          if (I_i_77 == 1) {
                                             G_d_18 = NormalizeDouble((PositionGetDouble(POSITION_VOLUME)() * I_d_45), (int)I_d_67);
                                          } else {
                                             G_d_18 = NormalizeDouble((PositionGetDouble(POSITION_VOLUME)() + Lot), (int)I_d_67);
                                          }
                                       } else {
                                          G_d_18 = I_d_44;
                                       }
                     ...
                     if ((I_d_69 > 0)) {
                        ...
                        if (G_i_99 >= 0) {
                           do {
                              I_b_7 = // OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_51, 0, 0);
                              if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetInteger(POSITION_TYPE)() == OP_BUY) {
                                 G_i_49 = PositionGetInteger(POSITION_TICKET)();
                                 if (G_i_49 > G_i_50) {
                     ...
                     if (I_i_76 == -2) {
                        ...
                        if (I_i_1 == 2) {
                           ...
                           if (G_i_106 >= 0) {
                              do {
                                 if (!// OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_53, 0, 1)) {
                                    G_d_20 = -3;
                                    break;
                                 }
                                 if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71) {
                                    G_l_8 = trade.PositionCloseTime();
                                    G_l_9 = G_i_52;
                                    if (G_l_9 < G_l_8) {
                                       G_i_52 = (int)trade.PositionCloseTime();
                                       if ((PositionGetDouble(POSITION_PROFIT)() < 0)) {
                                          if (I_i_77 == 1) {
                                             G_d_21 = NormalizeDouble((PositionGetDouble(POSITION_VOLUME)() * I_d_45), (int)I_d_67);
                                          } else {
                                             G_d_21 = NormalizeDouble((PositionGetDouble(POSITION_VOLUME)() + Lot), (int)I_d_67);
                                          }
                                       } else {
                                          G_d_21 = I_d_44;
                                       }
                     ...
                     if ((I_d_69 > 0)) {
                        ...
                        if (G_i_105 >= 0) {
                           do {
                              I_b_7 = // OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_56, 0, 0);
                              if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetInteger(POSITION_TYPE)() == OP_SELL) {
                                 G_i_54 = PositionGetInteger(POSITION_TICKET)();
                                 if (G_i_54 > G_i_55) {
               ...
               if ((L_d_2 > returned_double)) {
                  if (I_i_76 == -2) {
                     ...
                     if (I_i_1 == 2) {
                        ...
                        if (G_i_112 >= 0) {
                           do {
                              if (!// OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_58, 0, 1)) {
                                 G_d_23 = -3;
                                 break;
                              }
                              if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71) {
                                 G_l_10 = trade.PositionCloseTime();
                                 G_l_11 = G_i_57;
                                 if (G_l_11 < G_l_10) {
                                    G_i_57 = (int)trade.PositionCloseTime();
                                    if ((PositionGetDouble(POSITION_PROFIT)() < 0)) {
                                       if (I_i_77 == 1) {
                                          G_d_24 = NormalizeDouble((PositionGetDouble(POSITION_VOLUME)() * I_d_45), (int)I_d_67);
                                       } else {
                                          G_d_24 = NormalizeDouble((PositionGetDouble(POSITION_VOLUME)() + Lot), (int)I_d_67);
                                       }
                                    } else {
                                       G_d_24 = I_d_44;
                                    }
                  ...
                  if ((I_d_69 > 0)) {
                     ...
                     if (G_i_111 >= 0) {
                        do {
                           I_b_7 = // OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_61, 0, 0);
                           if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetInteger(POSITION_TYPE)() == OP_BUY) {
                              G_i_59 = PositionGetInteger(POSITION_TICKET)();
                              if (G_i_59 > G_i_60) {
                  ...
                  if (I_i_76 == -2) {
                     ...
                     if (I_i_1 == 2) {
                        ...
                        if (G_i_115 >= 0) {
                           do {
                              if (!// OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_63, 0, 1)) {
                                 G_d_26 = -3;
                                 break;
                              }
                              if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71) {
                                 G_l_12 = trade.PositionCloseTime();
                                 G_l_13 = G_i_62;
                                 if (G_l_13 < G_l_12) {
                                    G_i_62 = (int)trade.PositionCloseTime();
                                    if ((PositionGetDouble(POSITION_PROFIT)() < 0)) {
                                       if (I_i_77 == 1) {
                                          G_d_27 = NormalizeDouble((PositionGetDouble(POSITION_VOLUME)() * I_d_45), (int)I_d_67);
                                       } else {
                                          G_d_27 = NormalizeDouble((PositionGetDouble(POSITION_VOLUME)() + Lot), (int)I_d_67);
                                       }
                                    } else {
                                       G_d_27 = I_d_44;
                                    }
                  ...
                  if ((I_d_69 > 0)) {
                     ...
                     if (G_i_100 >= 0) {
                        do {
                           I_b_7 = // OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_66, 0, 0);
                           if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetInteger(POSITION_TYPE)() == OP_SELL) {
                              G_i_64 = PositionGetInteger(POSITION_TICKET)();
                              if (G_i_64 > G_i_65) {
   ...
   if (G_i_100 >= 0) {
      do {
         I_b_7 = // OrderSelect equivalent handled via PositionGetTicket in MQL5(G_i_68, 0, 0);
         if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71) {
            if (PositionGetInteger(POSITION_TYPE)() == OP_SELL || PositionGetInteger(POSITION_TYPE)() == OP_BUY) {
               G_i_67 = G_i_67 + 1;
            }
      ...
      do {
         ...
         if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71 && PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71) {
            if (PositionGetInteger(POSITION_TYPE)() == OP_BUY || PositionGetInteger(POSITION_TYPE)() == OP_SELL) {
               ...
               I_d_48 = ((G_d_78 * PositionGetDouble(POSITION_VOLUME)()) + I_d_48);
               L_d_12 = (L_d_12 + PositionGetDouble(POSITION_VOLUME)());
            }
         }
         I_i_84 = I_i_84 - 1;
      } while (I_i_84 >= 0);
   ...
   do {
      ...
      if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71) {
         if (PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71) {
            I_b_7 = OrderModify(PositionGetInteger(POSITION_TICKET)(), I_d_48, OrderStopLoss(), I_d_80, 0, 65535);
         }
         I_b_16 = false;
      }
      I_i_84 = I_i_84 - 1;
...
int f0_1(bool FuncArg_Boolean_00000000, bool FuncArg_Boolean_00000001) {
   ...
   do {
      if (// OrderSelect equivalent handled via PositionGetTicket in MQL5(L_i_12, 0, 0) && PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71) {
         if (PositionGetInteger(POSITION_TYPE)() == OP_BUY && FuncArg_Boolean_00000000) {
            RefreshRates();
            if (!IsTradeContextBusy()) {
               if (!trade.PositionClose(PositionGetInteger(POSITION_TICKET)(), PositionGetDouble(POSITION_VOLUME)(), NormalizeDouble(SymbolInfoDouble(_Symbol, SYMBOL_BID), _Digits), 5, 4294967295)) {
                  S_s_20 = (string)PositionGetInteger(POSITION_TICKET)();
               ...
               S_s_21 = (string)PositionGetInteger(POSITION_TICKET)();
         ...
         if (PositionGetInteger(POSITION_TYPE)() == OP_SELL && FuncArg_Boolean_00000001) {
            RefreshRates();
            if (!IsTradeContextBusy()) {
               if (!trade.PositionClose(PositionGetInteger(POSITION_TICKET)(), PositionGetDouble(POSITION_VOLUME)(), NormalizeDouble(SymbolInfoDouble(_Symbol, SYMBOL_ASK), _Digits), 5, 4294967295)) {
                  S_s_22 = (string)PositionGetInteger(POSITION_TICKET)();
               ...
               S_s_23 = (string)PositionGetInteger(POSITION_TICKET)();
...
int f0_15(int Fa_i_00, double Fa_d_01, double Fa_d_02, int Fa_i_03, double Fa_d_04, double Fa_d_05, int Fa_i_06, string Fa_s_07, int Fa_i_08, int Fa_i_09, int Fa_i_0A) {
   ...
   if (I_i_1 == 2) {
      ...
      do {
         ...
         L_i_11 = trade.Buy(_Symbol, 2, Fa_d_01, Fa_d_02, Fa_i_03, G_d_2, G_d_3, Fa_s_07, Fa_i_08, Fa_i_09, G_i_31);
         if (L_i_11 > 0) {
            I_i_76 = I_i_76 + 1;
         }
   ...
   if (I_i_1 == 4) {
      ...
      do {
         ...
         L_i_11 = trade.Buy(_Symbol, 4, Fa_d_01, Fa_d_02, Fa_i_03, G_d_109, G_d_111, Fa_s_07, Fa_i_08, Fa_i_09, G_i_33);
         if (L_i_11 > 0) {
            I_i_76 = I_i_76 + 1;
         }
         G_i_35 = GetLastError();
   ...
   if (I_i_1 == 0) {
      ...
      do {
         ...
         G_i_36 = Fa_i_0A;
         G_i_16 = Fa_i_06;
         G_d_4 = SymbolInfoDouble(_Symbol, SYMBOL_ASK);
         if (Fa_i_06 == 0) {
            G_d_115 = 0;
         } else {
         ...
         G_i_14 = (int)I_d_82;
         G_d_114 = SymbolInfoDouble(_Symbol, SYMBOL_BID);
         if (G_i_14 == 0) {
            G_d_113 = 0;
         } else {
         ...
         L_i_11 = trade.Buy(_Symbol, 0, Fa_d_01, SymbolInfoDouble(_Symbol, SYMBOL_ASK), Fa_i_03, G_d_113, G_d_115, Fa_s_07, Fa_i_08, Fa_i_09, G_i_36);
         if (L_i_11 > 0) {
            I_i_76 = I_i_76 + 1;
         }
   ...
   if (I_i_1 == 3) {
      ...
      do {
         ...
         L_i_11 = trade.Buy(_Symbol, 3, Fa_d_01, Fa_d_02, Fa_i_03, G_d_116, G_d_118, Fa_s_07, Fa_i_08, Fa_i_09, G_i_38);
         if (L_i_11 > 0) {
            I_i_76 = I_i_76 + 1;
         }
         G_i_40 = GetLastError();
   ...
   if (I_i_1 == 5) {
      ...
      do {
         ...
         L_i_11 = trade.Buy(_Symbol, 5, Fa_d_01, Fa_d_02, Fa_i_03, G_d_119, G_d_121, Fa_s_07, Fa_i_08, Fa_i_09, G_i_41);
         if (L_i_11 > 0) {
            I_i_76 = I_i_76 + 1;
         }
         G_i_43 = GetLastError();
   ...
   if (I_i_1 == 1) {
      ...
      do {
         G_i_44 = Fa_i_0A;
         G_i_30 = Fa_i_06;
         G_d_8 = SymbolInfoDouble(_Symbol, SYMBOL_BID);
         if (Fa_i_06 == 0) {
            G_d_124 = 0;
         } else {
         ...
         G_i_28 = (int)I_d_82;
         G_d_123 = SymbolInfoDouble(_Symbol, SYMBOL_ASK);
         if (G_i_28 == 0) {
            G_d_7 = 0;
         } else {
            G_d_7 = ((G_i_28 * _Point) + G_d_123);
         }
         L_i_11 = trade.Buy(_Symbol, 1, Fa_d_01, SymbolInfoDouble(_Symbol, SYMBOL_BID), Fa_i_03, G_d_7, G_d_124, Fa_s_07, Fa_i_08, Fa_i_09, G_i_44);
         if (L_i_11 > 0) {
            I_i_76 = I_i_76 + 1;
         }
         G_i_46 = GetLastError();
...
void f0_18(int Fa_i_00, int Fa_i_01, double Fa_d_02) {
   ...
   if (L_i_16 < 0) return;
   do {
      if (// OrderSelect equivalent handled via PositionGetTicket in MQL5(L_i_16, 0, 0) && PositionGetString(POSITION_SYMBOL)() == _Symbol && PositionGetInteger(POSITION_MAGIC)() == I_i_71) {
         if (PositionGetString(POSITION_SYMBOL)() == _Symbol || PositionGetInteger(POSITION_MAGIC)() == I_i_71) {
            if (PositionGetInteger(POSITION_TYPE)() == OP_BUY) {
               G_d_2 = (SymbolInfoDouble(_Symbol, SYMBOL_BID) - Fa_d_02);
               ...
               L_d_14 = (SymbolInfoDouble(_Symbol, SYMBOL_BID) - G_d_2);
               if (returned_double == 0 || (returned_double != 0 && L_d_14 > returned_double)) {
                  I_b_7 = OrderModify(PositionGetInteger(POSITION_TICKET)(), Fa_d_02, L_d_14, OrderTakeProfit(), 0, 16776960);
               }
            }
            if (PositionGetInteger(POSITION_TYPE)() == OP_SELL) {
               G_d_106 = (Fa_d_02 - SymbolInfoDouble(_Symbol, SYMBOL_ASK));
               L_i_15 = (int)NormalizeDouble((G_d_106 / _Point), 0);
               if (L_i_15 < Fa_i_00) continue;
               returned_double = OrderStopLoss();
               L_d_13 = returned_double;
               L_d_14 = ((Fa_i_01 * _Point) + SymbolInfoDouble(_Symbol, SYMBOL_ASK));
               if (returned_double == 0 || (returned_double != 0 && L_d_14 < returned_double)) {
                  I_b_7 = OrderModify(PositionGetInteger(POSITION_TICKET)(), Fa_d_02, L_d_14, OrderTakeProfit(), 0, 255);
               }
            }
         }
         Sleep(1000);
